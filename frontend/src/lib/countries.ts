// Static ISO-3166 country list with E.164 calling codes — no dependency pulled in for
// this (e.g. libphonenumber-js) since only a name + dial-code lookup is needed, not
// real phone-number parsing/validation.
export type Country = {
  name: string;
  iso2: string;
  dialCode: string;
