      ...
      <RegulatoryPrimer
        ...
        pillars={[
          ...
          },
          {
            ...
            description:
              "Long-term legal authorization enabling individuals to live and work in the UAE — employer-sponsored visas, self-sponsored 5-Year Green Visas for freelancers and skilled workers  10-Year Golden Visas for investors, entrepreneurs  specialized talent.",
          },
          {
            icon: BadgeCheck,
            title: "Citizenship",
            description:
              "A selective statutory pathway allowing qualifying investors, doctors, scientists  exceptional talents to acquire UAE citizenship under strict legal criteria.",
          },
        ]}
        ...
        authorities={[
          {
            ...
            description:
              "Manages federal immigration policy, entry/residence permits  issues Establishment Cards across Abu Dhabi and the Northern Emirates.",
          },
          {
            icon: Landmark,
            name: "GDRFA — General Directorate of Residency and Foreigners Affairs",
            description:
              "The emirate-level immigration authority managing residency services, entry permits  Establishment Card issuances specifically within Dubai.",
          },
        ]}
        penalties={[
          {
