...
const SECTIONS: LegalSectionData[] = [
  {
    ...
    paragraphs: [
      "The information provided on this Website is for general informational and promotional purposes only. It is intended to give an overview of DSD Corporate Services, our services  general business-related matters in the United Arab Emirates (\"UAE\").",
  ...
  },
  {
    ...
    paragraphs: [
      "Nothing on this Website constitutes legal, tax, accounting, financial, banking, immigration or investment advice  nothing on this Website should be relied upon as such.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "A formal service relationship with DSD begins only once DSD has accepted the engagement, the required due diligence and compliance checks have been completed to DSD's satisfaction, the parties have agreed on the scope of services, fees and conditions  a service agreement, quotation, engagement letter or other written confirmation has been issued by DSD and accepted by the client.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Where applicable, DSD is required to carry out customer due diligence, verify the identity of clients, shareholders, directors and beneficial owners, screen clients against applicable sanctions lists  report suspicious activity to the competent authorities.",
      "DSD reserves the right, at its sole discretion, to decline, delay, suspend or terminate an engagement, application or transaction where a client's information cannot be verified or a compliance, sanctions or source of funds concern arises  shall not be liable for any loss arising from such a decision.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "DSD may introduce or refer clients to third-party providers, including banks, insurers, auditors, accountants, lawyers, tax advisers, translators, landlords, real estate agents, free zones, government service centres  technology providers.",
      "Unless expressly agreed otherwise in writing, these third parties operate independently and are responsible for their own services, advice, pricing, conduct and contractual obligations. A referral does not constitute a guarantee or endorsement of a third party  clients should conduct their own due diligence before appointing or paying any third-party provider.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "We aim to keep this Website available and secure but do not guarantee continuous or uninterrupted access. Users are responsible for protecting their own devices, accounts  information against malware, phishing, unauthorised access  other online threats.",
  ...
  },
  {
    ...
    paragraphs: [
      "Testimonials, reviews, case studies  examples on this Website describe individual experiences and do not guarantee that another client will obtain the same result. Outcomes depend on the client's eligibility, documentation, selected activity, jurisdiction, regulatory requirements  decisions made by the relevant authorities or third parties.",
    ],
  },
  {
  ...
  },
  {
    ...
    list: [
      ...
      "Electronic form: This Disclaimer is issued  may be updated, in electronic form and constitutes a valid and binding notice under Federal Decree-Law No. 46 of 2021 on Electronic Transactions and Trust Services.",
    ],
  },
  {
    heading: "Changes to this Disclaimer",
    paragraphs: [
      "DSD may update this Disclaimer to reflect changes in its services, business practices, Website functions or applicable legal requirements. The revised version becomes effective immediately upon publication  continued use of the Website following publication constitutes acceptance of the revised Disclaimer.",
    ],
  },
  {
    heading: "Governing law and jurisdiction",
    paragraphs: [
      "This Disclaimer  any dispute arising out of or in connection with the use of this Website, is governed by the federal laws of the United Arab Emirates and the laws applicable in the Emirate of Ajman, together with the rules and regulations of ANCFZ where applicable.",
