...
const SECTIONS: LegalSectionData[] = [
  ...
  },
  {
    ...
    list: [
      "Respond to enquiries, provide quotations  verify your identity and eligibility",
      "Create and manage client records and provide company-formation and corporate-support services",
      "Prepare and submit applications  communicate with licensing, immigration, tax  free zone authorities",
      "Coordinate services with banks and authorised third-party providers",
      "Prepare contracts, invoices, receipts  payment records",
      "Conduct know-your-customer, sanctions, fraud-prevention  other compliance checks",
      "Meet accounting, tax, regulatory  record-keeping obligations",
      "Maintain and improve our website and services  protect our systems against fraud or misuse",
      "Send service updates and, where permitted, marketing communications",
      "Establish, exercise or defend legal rights  comply with applicable laws and regulatory requests",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Corporate-service applications may require detailed information about shareholders, directors, managers, employees, authorised representatives  beneficial owners. DSD may verify this information using official documents, public records, government systems  approved verification providers  may conduct sanctions, politically-exposed-person  fraud-prevention checks where required.",
  ...
  },
  {
    ...
    list: [
      "UAE federal or local government, immigration, labour, licensing, tax  free zone authorities",
      "Municipalities, embassies  consulates",
      "Banks, insurers  payment providers",
      "Lawyers, accountants, auditors, tax advisers  translators",
      "Notaries, attestation providers  document-clearing centres",
      "Technology, hosting, cybersecurity  communications providers",
      "Courts, law-enforcement agencies  regulators",
  ...
  },
  {
    ...
    paragraphs: [
      "We retain personal information only as long as reasonably necessary to provide the requested services, maintain accurate records, meet legal and regulatory requirements, resolve disputes, prevent fraud  establish or defend legal claims. Retention periods vary by record type and applicable legal requirements. When information is no longer required, we take reasonable steps to securely delete, destroy or anonymise it.",
    ],
  },
  {
    heading: "Information security",
    paragraphs: [
      "We use reasonable administrative, organisational  technical safeguards designed to protect personal information against unauthorised access, accidental loss, improper disclosure, unlawful alteration, misuse  destruction.",
      "No website, email service or electronic storage system is completely secure. Avoid sending passports, Emirates IDs, banking details or other sensitive documents through unverified channels  always confirm payment instructions through an official DSD contact before transferring money.",
    ],
  },
  {
    heading: "Cookies",
    paragraphs: [
      "Our website may use cookies and similar technologies to operate securely, remember preferences, measure performance , where permitted, support advertising. Please read our Cookie Policy for further information.",
    ],
  },
  {
    heading: "Marketing communications",
    paragraphs: [
      "Where permitted, we may use your contact information to send information about DSD services, business updates or promotional offers. You may opt out at any time using the unsubscribe option, by replying with an opt-out request or by contacting info@dsdgrp.com. Opting out of marketing will not prevent essential messages about an active enquiry, application, payment or service.",
    ],
  },
  {
    heading: "Your rights",
    ...
    list: [
      "Obtain information about how your personal information is processed  request access to it",
      ...
      "Object to or stop direct marketing  withdraw consent",
  ...
  },
  {
    ...
    paragraphs: [
      "DSD does not intend to make decisions producing significant legal effects solely through automated processing unless the process is lawful, necessary  appropriately disclosed. Where required, meaningful human review will be available.",
    ],
  },
  {
  ...
  },
  {
    heading: "Contact us",
    paragraphs: [
      "For questions, requests or complaints concerning personal information, contact us using the details below. Requests may also be submitted to info@dsdgrp.com.",
    ],
  },
];
